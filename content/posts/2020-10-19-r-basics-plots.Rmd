...
So far we have gone over [basic statistics](https://realmagic.netlify.app/posts/r-basics-descriptive-statistics/) and plotting in R.  But there is still more to go to build up the basic skills!  We still have importing data and test statistics. Join me next week for importing various data files into R. 
