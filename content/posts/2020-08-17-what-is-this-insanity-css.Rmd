...
As I stated earlier, the challenge with CSS is figuring out how it comunicates with HTML.  The basic version is that CSS defines specific styles for each element in an HTML document.  The style sheet will be a series of code chunks that look like this:
