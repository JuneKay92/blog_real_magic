...
There are obviously more basics to go over in R: [Plots](https://realmagic.netlify.app/posts/r-basics-plots/) for data visualization, [importing your data](https://realmagic.netlify.app/posts/importing-data-into-r/), and test statistics for inference. Join me next week for some basics about plots in R.  